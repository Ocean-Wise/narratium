...
function KTT_post_cover() {
  ...
  <div class="padding-left-40 padding-right-40 padding-bottom-20 <?php echo KTT_get_content_width_classname();?> width-100 typography-responsive">
  <div class="width-100 text-align-left  " >
		...
		<h2 class="typo-weight-300 opacity-05 padding-top-10 padding-bottom-10 site-typeface-headline text-size-large post-subtitle">
		...
		<p class="classic-link-inside text-size-small padding-bottom-10 opacity-04">
				...
				<span class="meta ornament-line-before-amper">
					<?php echo sprintf(esc_html__('%s min read', 'narratium'), KTT_display_post_read_time());?>
				</span>
				<?php } ?>
      ...
      <div data-flex data-hide-xs class="post-item-meta" >
				...
				<div class="classic-link-inside typo-size-xsmall opacity-03"><?php echo $post->post_credits;?></div>
				<?php } ?>
      </div>
    ...
    <div data-flex id="site-body">
        ...
        */
        $args = array(
              ...
              "card_classes" => "height-100vh link-white-color backdrop-dark-gradient-light min-height-600px site-palette-yang-1-color",
        ...
        */
        ...
        <?php
          // If comments are open or we have at least one comment, load up the comment template
					if (is_single()) if ( comments_open() || '0' != get_comments_number() ) :
            comments_template();
          endif;
        ?>
