...
function your_customize_backend_init(){
	wp_enqueue_script('KTT_wp_editor_setting_customizer', get_parent_theme_file_uri('kohette-framework/modules/settings-creator/options/option-wp_editor/js/customizer.js'));
}
