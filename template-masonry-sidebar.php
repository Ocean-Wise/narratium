        ...
        class="text-align-left">
          <?php while (have_posts()) : the_post(); ?>
                ...
                class=" site-palette-yang-4-border-color padding-both-50">
                  ...
                  <a title="<?php the_title();?>" href="<?php the_permalink();?>" class="classic-link display-block site-palette-yin-2-color padding-bottom-5 site-typeface-title typo-size-xlarge post-title">
