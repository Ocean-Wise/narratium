			...
			<td>
					...
					<div id="upload-field-<?php echo esc_attr($var_id);?>">
                        ...
                        <div  style="margin-bottom:20px;<?php if (!$value) {?>display:none;<?php } ?>"  class="show-on-image">
                            ...
                            <img alt="<?php echo esc_html__('Profile avatar image', 'narratium');?>" id="uploaded-image-<?php echo esc_attr($var_id);?>" style="display:block;max-height:160px;max-width:500px;" src="<?php echo esc_url($image_src);?>">

                        </div>

                       <span
                       data-uploader_title="<?php echo esc_html__('Profile avatar image', 'narratium');?>"
