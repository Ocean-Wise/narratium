    ...
    <div  id="site-body" <?php if (is_single()) post_class();?>>
            ...
            <?php if (have_posts()) : ?>
                  ...
                  <?php } else {?>
                        ...
                        <p>
                          <a class="typo-size-xsmall site-typeface-body margin-left-5 display-inline-block border-style-solid  md-whiteframe-2dp border-width-2 border-radius-5 padding-top-10 padding-left-20 padding-right-20 button-behaviour padding-bottom-10 " title="" href="<?php echo the_permalink();?>">
