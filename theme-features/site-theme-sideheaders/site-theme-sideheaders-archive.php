<?php
/**
* This sideheader is displayed in the frontpage and by default in the pages that do not have other types of sideheaders...
*/
...
*/
function KTT_archive_sideheader() {
      ...
      */
      $args = array(
          ...
          */
          "card_background_attachment" => KTT_get_featured_image_from_current_posts(),

          /**
          * We call the function that is in charge of creating the content of the site header, we only pass on the name of the project because this parameter acts as a callback...
          */
          "card_content" => "KTT_archive_sideheader_content",
...
*/
function KTT_archive_sideheader_content() {
